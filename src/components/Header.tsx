      ...
      <div className="container mx-auto px-4 py-3">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            <div className="h-16 w-16 rounded-full bg-gradient-to-br from-rangoli-orange/70 to-rangoli-pink/50 p-2 flex items-center justify-center mr-3 shadow-md">
              <span className="font-dancing text-3xl font-bold text-white">AC</span>
            </div>
            <div>
