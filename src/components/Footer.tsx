        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div>
            <div className="flex items-center mb-6">
              <div className="h-12 w-12 rounded-full bg-white/20 p-2 flex items-center justify-center mr-3">
                <span className="font-dancing text-xl font-bold text-white">AC</span>
              </div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/918275690018" target="_blank" rel="noopener noreferrer" 
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+918275690018" className="text-white/80 hover:text-white transition-colors">
                  +91 8275690018
                </a>
              </li>
              <li className="flex items-center">
                <MessageSquare size={20} className="mr-3 flex-shrink-0" />
                <a href="https://wa.me/918275690018" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors">
                  WhatsApp: +91 8275690018
                </a>
              </li>
              <li className="flex items-center">
